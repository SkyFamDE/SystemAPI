...
public class NPC_SantaClaus implements Serializable {
    ...
    public NPC_SantaClaus(String name, Location location) {
        entityID = (int) Math.ceil(Math.random() * 1000) + 2000;
        gameprofile = new GameProfile(UUID.randomUUID(), name);
        this.location = location.clone();
    }

    public NPC_SantaClaus(String name, Integer entityID, UUID uuid, Location location) {
    ...
    public static NPC_SantaClaus decode(HashMap<String, Object> map) {
        ...
        NPC_SantaClaus npc = new NPC_SantaClaus(name, entityID, uuid, location);
